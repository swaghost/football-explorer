...
@Component({
  selector: 'app-mini-match-editor',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './mini-match-editor.component.html',
  styleUrls: ['./mini-match-editor.component.scss'],
})
export class MiniMatchEditorComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  // Drawer state for control panels
  openDrawer: 'sequence' | 'view' | 'formations' | 'players' | null = null;
  toolbarSide: 'left' | 'right' = 'right'; // Can be set via @Input if needed
  ...
  // Drawer Management
  toggleDrawer(drawer: 'sequence' | 'view' | 'formations' | 'players'): void {
    this.openDrawer = this.openDrawer === drawer ? null : drawer;
  }
  ...
  openDrawerExclusive(
    drawer: 'sequence' | 'view' | 'formations' | 'players'
  ): void {
