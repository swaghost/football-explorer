    ...
    this.store
      ...
      .subscribe((lesson) => {
        if (lesson) {
          ...
          // Auto-open the Lesson Runner V2 toolbar
          const isLessonRunnerV2Visible = this.store.selectSnapshot(
            (state: any) => state.sketch?.toolbarVisibility?.lessonRunnerV2
          );

          if (!isLessonRunnerV2Visible) {
            console.log('🏃 Auto-opening Lesson Runner V2 toolbar');
            this.showToolbar('lessonRunnerV2');
          }
